...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  receiver.o register.o sender.o subnet.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#-
...
#^|
receiver.o: /cygdrive/C/eclipse/workspace/zzalternatebitprot/receiver.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/zzalternatebitprot/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
sender.o: /cygdrive/C/eclipse/workspace/zzalternatebitprot/sender.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
subnet.o: /cygdrive/C/eclipse/workspace/zzalternatebitprot/subnet.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
receiver.o: \
 /cygdrive/C/eclipse/workspace/zzalternatebitprot/receiver.cpp \
 /cygdrive/C/eclipse/workspace/zzalternatebitprot/receiver.h \
...
register.o: \
 /cygdrive/C/eclipse/workspace/zzalternatebitprot/register.cpp \
 ...
 /cygdrive/C/eclipse/workspace/zzalternatebitprot/receiver.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/workspace/zzalternatebitprot/sender.h \
 /cygdrive/C/eclipse/workspace/zzalternatebitprot/subnet.h
sender.o: /cygdrive/C/eclipse/workspace/zzalternatebitprot/sender.cpp \
 /cygdrive/C/eclipse/workspace/zzalternatebitprot/sender.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
